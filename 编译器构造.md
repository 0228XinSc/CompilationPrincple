...
>
> 常数定义 ConstDef`↓Attr_DataType ↓Attr_IdnetType` → Ident`↑Attr_Name` { '[' ConstExp ']' }`↓Attr_DataType ↑Attr_DataType` '  `@insertSymbolList↓Attr_DataType↓Attr_Name`  `@RunStackPush ↓j` ‘=' ConstInitVal `@Sem_sto`
